...
export const portfolio = {
  es: {
    ...
    labs: [
      ...
      { id: "container-metrics", kind: "metrics", title: "Observabilidad de servicios", summary: "Uso de CPU y memoria de los servicios de mi servidor personal, consultado a través de Prometheus.", status: "active", statusLabel: "En directo", technologies: ["Prometheus", "Contenedores"], titleLabel: "Métricas de servicios", cpuLabel: "CPU", memoryLabel: "Memoria", servicesLabel: "Servicios", previousLabel: "Intervalo anterior", nextLabel: "Intervalo siguiente", nowLabel: "Volver a ahora", loadingLabel: "Cargando métricas", unavailableLabel: "Las métricas no están disponibles ahora.", noDataLabel: "No hay muestras en este intervalo." },
  ...
  en: {
    ...
    labs: [
      ...
      { id: "container-metrics", kind: "metrics", title: "Service observability", summary: "CPU and memory use from my personal server services, queried through Prometheus.", status: "active", statusLabel: "Live", technologies: ["Prometheus", "Containers"], titleLabel: "Service metrics", cpuLabel: "CPU", memoryLabel: "Memory", servicesLabel: "Services", previousLabel: "Previous interval", nextLabel: "Next interval", nowLabel: "Back to now", loadingLabel: "Loading metrics", unavailableLabel: "Metrics are unavailable right now.", noDataLabel: "There are no samples in this interval." },
    ] satisfies (RelayLab | MetricsLab)[],
