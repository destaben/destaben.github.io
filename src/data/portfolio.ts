...
export const portfolio = {
  es: {
    ...
    experience: { label: "Trayectoria", title: "Experiencia en software, cloud y operaciones.", items: [
      ...
      { period: "may 2020 - abr 2021", role: "Cloud Engineer", company: "everis", focus: "Infraestructura cloud, optimización de costes e integración." },
      ...
      { period: "jul 2017 - feb 2018", role: "Integrador de sistemas", company: "Orbe Telecomunicaciones, S.L.", focus: "Integración de seguridad, redes, telefonía y sistemas Linux y Windows." },
  ...
  en: {
    ...
    experience: { label: "Experience", title: "Experience across software, cloud, and operations.", items: [
      ...
      { period: "May 2020 - Apr 2021", role: "Cloud Engineer", company: "everis", focus: "Cloud infrastructure, cost optimisation, and integration." },
      ...
      { period: "Jul 2017 - Feb 2018", role: "Systems Integrator", company: "Orbe Telecomunicaciones, S.L.", focus: "Security, network, telephony, and Linux and Windows systems integration." },
