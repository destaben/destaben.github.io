---
title: "Signal Relay: un punto de contacto directo con Reticulum"
description: "La arquitectura de una dirección LXMF pública, una bandeja respetuosa con la privacidad y métricas operativas separadas."
locale: es
pubDate: 2026-09-19
...
Un navegador no es un cliente Reticulum. La web no debe ocultarlo ni convertir un formulario en un sustituto engañoso de la mensajería directa. Un servicio propio mantiene una única dirección de entrega con la implementación oficial de Reticulum y LXMF.
...
3. El bridge conserva una identidad LXMF persistente y recibe mensajes directos en su dirección de entrega.
